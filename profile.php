<?php 
            ...
            $u = $obj_admin->display_one("users","user_id",$uid);
            if($u['user_id']==""){
            ...
            $tww = $obj_admin ->count("tweets","tweet_by","$uid");
    ...
    <div class="center">
        ...
        <div class="flex justify-between  px-3 text-[14px]">
            ...
            <span class="shrink-0">
                ...
                <a href="edit-profile"><span class="float-right px-2 border border-black rounded-full px-3 py-1 ml-4 bg-[#006175] text-white text-[14px] cursor-pointer">
                Edit Profile
                </span>
                </a>
            </div>
        ...
        <div class="grid grid-cols-3 text-center my-4">
            <span class="border-r border-black">
                <p class="font-semibold"><?php echo $tww ?></p>
                <p>Posts</p>
            </span>
            <span class="border-r border-black">
        ...
        if ($tweets[0]['tweet_id']=="") { ?>
             <div class="p-3" >You don't have any tweets. :(  </div>
        <?php }else{
             foreach($tweets as $t){ 
...
<script type="text/javascript">
    	$("#profile").attr("src","img/mycollection/user-active.png");
